...
from core.views import home, trocar_senha_obrigatoria
...
urlpatterns = [
            ...
            path('senha/troca-obrigatoria/', trocar_senha_obrigatoria, name='trocar_senha_obrigatoria'),
            ...
            # API endpoints
            path('api/pcp/', include('pcp.api.urls')),
